        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                $('#MantenimientoTablaContenidos').jtable({
                    ...
                    useBootstrap: true,
                    actions: {
                        listAction: '../srvEnfermedad_sintoma?varPostAccion=Select',
                        createAction: '../srvEnfermedad_sintoma?varPostAccion=Insert',
                        updateAction: '../srvEnfermedad_sintoma?varPostAccion=Update',
                        deleteAction: '../srvEnfermedad_sintoma?varPostAccion=Delete'
                    },
                    fields: {
                        id: {
                            title: 'Id',
